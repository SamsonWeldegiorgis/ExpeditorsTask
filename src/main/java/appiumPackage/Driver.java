        ...
        if (Objects.isNull(driver)) {
            switch (platform) {
                ...
                case "android-swaglab":
                    ...
                    desiredCapabilities2.setCapability(MobileCapabilityType.APP, "C:\\Users\\Saron Tsegay\\IdeaProjects\\AppiumTestsB26\\Android.SauceLabs.Mobile.Sample.app.2.7.1.apk");
